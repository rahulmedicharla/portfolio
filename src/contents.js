export const content = {
  ...
  leadership: [],
  skills: [
    "Go, Java, Go, Python, C/C++",
    "TS, React, .NET, Flask",
    "Kuberenetes, AWS, Azure, GCP, Docker",
    "Pytorch, Tensorflow, Weights & Biases",
  ],
  experience: [
    {
    ...
    },
    {
      ...
      stack: "PyTorch, W&B, Pandas, Numpy",
      website: "https://u.osu.edu/pcvlab/",
      tag: "pcvlab",
      img: "/osu.png",
      link: {
        uri: "https://arxiv.org/abs/2512.24231",
        title:
  ...
  creations: [
    ...
    },
    {
      ...
      github:
        "https://github.com/rahulmedicharla/Generalized-CV-Tracking-Algorithm",
      img: "/freetrack.png",
    ...
    content: [
      {
        ...
        content: [
          {
            title: "K6 Open Source Contribution",
            link: "https://github.com/grafana/k6/releases/tag/v1.6.0",
            description:
              "Implemented the PBKDF2 Crypto Key Derivation Function in K6's Open Source Repo.",
          },
          {
            title:
            ...
            description:
              "This article discusses the impact of technology on healthcare and how it's changing the way we approach medicine.",
          },
        ],
      },
      {
        ...
        content: [
          {
            ...
            description:
              "A great article on the future of AI and art and its conflicting ideas about the creative industry.",
          },
          {
            title: "Food is a Universal Language",
            link: "https://www.faseb.org/diversity-equity-and-inclusion/food-is-a-universal-language",
            description:
              "Food is a language every human understands. It's something that is deeply rooted in culture, history, and something that connects us all.",
          },
        ],
      },
      {
        ...
        content: [
          {
            ...
            description:
              "This article discusses the future of autonomous vehicles and the interconnected features it could provide.",
          },
        ],
      },
    ],
